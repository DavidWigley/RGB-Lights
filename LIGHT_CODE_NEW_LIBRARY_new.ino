...
void chase(int r, int g, int b, uint8_t wait, CRGB strip, int numLEDs, int chaseLength, int cycles){
	...
	for(int led_number = 0; led_number < numLEDs; led_number++){
                //currently writing this late at night. Logic makes sense to tired David please check future David.
